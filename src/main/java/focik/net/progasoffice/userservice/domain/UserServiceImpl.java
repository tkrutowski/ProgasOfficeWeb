...
import focik.net.progasoffice.userservice.domain.exceptions.PasswordNotFoundException;
...
import static focik.net.progasoffice.userservice.domain.security.constant.UserConstant.*;
